...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/MrZstOnly/myTestSpecLib.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '550808296@qq.com' => '550808296@qq.com' }
  # s.source           = { :git => 'https://github.com/MrZstOnly/PodTest.git', :tag => s.version.to_s }
  s.source           = { :git => 'https://github.com/MrZstOnly/myTestSpecLib.git', :tag => s.version.to_s }
